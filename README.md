...
This repository was originally forked from the [runit-swap](https://github.com/thypon/runit-swap) repository since I saw it as a nice method to either enable and use zram, zswap, or a swapfile, just by using a somewhat well-written wrapper shell script.
